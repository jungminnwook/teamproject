		...
		<div class="container">
										...
										<c:forEach var="product" items="${ proList }">
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="product__item">
													<a href="/products/details"><div class="product__item__pic set-bg"
            ...
            <nav aria-label="Page navigation example">
              ...
              <li class="page-item ${ (pageMaker.prev) ? '' : 'disabled' }">
              	<a class="page-link" href="${ (pageMaker.prev) ? '/products/productsList?pageNum=' += (pageMaker.startPage - 1): '' }#board">이전</a>
              </li>
              
              <%-- 시작페이지 번호 ~ 끝페이지 번호 --%>
              <c:forEach var="i" begin="${ pageMaker.startPage }" end="${ pageMaker.endPage }" step="1">
              	<li class="page-item ${ (pageMaker.cri.pageNum eq i) ? 'active' : '' }">
              		<a class="page-link" href="/products/productsList?pageNum=${ i } #board">${ i }</a>
              	</li>
              </c:forEach>
              
              <%-- 다음 --%>
              <li class="page-item  ${ (pageMaker.next) ? '' : 'disabled' }">
              	<a class="page-link" href="${ (pageMaker.next) ? '/products/productsList?pageNum=' += (pageMaker.endPage + 1) : '' }#board">다음</a>
              </li>
