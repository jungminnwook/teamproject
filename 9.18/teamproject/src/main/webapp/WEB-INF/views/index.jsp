...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__option">
            <ul>
                ...
                <li><a href="/member/login">Sign in</a> <span class="arrow_carrot-down"></span></li>
                <li><a href="/member/join">Join</a> <span class="arrow_carrot-down"></span></li>
            </ul>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
    ...
    <header class="header">
    	<div class="header__banner-left"><h3>배너자리배너자리배너자리배너자리배너자리배너자리배너자리</h3></div>
    	<div class="header__banner-right"><h3>리모컨자리리모컨자리리모컨자리리모컨자리리모컨자리리모컨자리</h3></div>
                    ...
                    <div class="col-lg-12">
                        <div class="header__top__inner">
                            ...
                            <div class="header__logo">
                                <a href="./index.jsp"><img src="/resources/img/logo_widthVer.png" alt=""></a>
                            </div>
